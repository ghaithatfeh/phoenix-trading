...
function App() {
  return (
    <>
      <div className={"relative h-screen w-full bg-black"}>
        ...
        <div className={"flex items-center justify-center py-10"}>
          ...
          >
            <a
              href={"/"}
              className={`${window.location.pathname == "/" ? "!text-red-700" : ""} hover:text-red-400`}
            >
              Home
            </a>
            <a
              href={"/our-products"}
              className={`${window.location.pathname == "/our-products" ? "!text-red-700" : ""} hover:text-red-400`}
            >
              Our Products
            </a>
            <a
              href={"/contact-us"}
              className={`${window.location.pathname == "/contact-us" ? "!text-red-700" : ""} hover:text-red-400`}
            >
              Contact Us
            </a>
          </nav>
        ...
        <div className={"flex w-full items-center justify-between"}>
          <div className={"w-[60%]"}>
            <h1 className={"ps-26 text-6xl font-bold text-red-700"}>
              Welcome to Phoenix
            </h1>
      ...
      <div className="relative h-[35vh] w-full bg-red-600/80">
        <img
      ...
      <div className={"w-full bg-black"}>
        ...
        <div className={"flex flex-col items-start space-y-16 px-26"}>
          <div className={"flex items-center justify-between gap-2"}>
            <div className={"h-full border-r-2 border-r-red-800 py-4 pe-2"}>
        ...
        <div className={"px-26 pb-10"}>
          <h1 className={"mb-10 text-start text-3xl font-bold text-red-700"}>
          ...
          <div className={"flex w-full items-center justify-between"}>
            ...
            >
              <div className={"flex items-center gap-2 text-2xl text-white"}>
                ...
                <Phone className={"fill-red-700 text-red-700"} />
                +1 (437) 231-1444
              </div>
